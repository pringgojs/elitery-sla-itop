            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <div class="sm:flex sm:space-x-5">
                    <div class="flex-shrink-0">
                        <svg class="mx-auto h-20 w-20 rounded-full text-gray-300" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;"
                                ...
                                <path
                                    d="M 62.429 55.079 c -3.442 2.75 -7.5 4.261 -10.288 4.743 l -0.354 3.539 c 3.682 -1.565 7.559 -3.932 11.632 -7.099 L 62.429 55.079 z"
                                    ...
                                    transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round" />
                                <path
                                    d="M 27.063 53.474 c 5.13 4.099 11.18 6.352 15.335 7.07 l 0.528 5.275 c -5.488 -2.333 -11.267 -5.86 -17.338 -10.582 L 27.063 53.474 z"
                                    style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(105,64,49); fill-rule: nonzero; opacity: 1;"
                                    transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round" />
                                <path
                                    d="M 52.991 48.359 c -0.835 7.356 -3.874 13.97 -6.621 17.85 l 3.776 4.633 c 2.527 -6.231 4.335 -13.647 5.426 -22.25 L 52.991 48.359 z"
                                    style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(105,64,49); fill-rule: nonzero; opacity: 1;"
                                    transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round" />
                                <path
                                    d="M 55.901 90 c -6.594 -6.586 -2.545 -18.917 -5.131 -27.863 c -2.637 -6.873 -4.699 -9.662 -4.89 -16.624 h -1.823 c -0.849 4.947 -0.315 10.133 1.823 15.595 c -3.321 -4.643 -6.821 -8.047 -10.531 -9.988 l -1.881 1.897 c 4.548 3.296 8.895 9.794 8.498 17.247 c 0 8.93 -1.175 14.565 -6.223 19.735 H 55.901 z"
                    ...
                    <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                        <p class="text-sm font-medium text-gray-600">{{ date_format_human($form->date_of_activity) }}
                        </p>
                        <p class="text-xl font-bold text-gray-900 sm:text-2xl">{{ $form->activity_organizer }}</p>
                        <p class="text-sm font-medium text-gray-600">
                            {{ $form->village->name }} - {{ $form->district->name }} - ({{ $form->regency->name }})
                        </p>
                    </div>
                </div>
