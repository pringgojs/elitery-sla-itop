<div>
    ...
    <div class="bg-white shadow px-5 py-5">
        {{-- filter --}}
        {{-- @livewire('pages.seed.section.filter') --}}
        ...
        <ul role="list" class="divide-y divide-gray-100">
            @foreach ($seeds as $item)
                <li wire:key="seeds-{{ $item->id }}" class="flex items-center justify-between gap-x-6 py-5">
                    <div class="min-w-0">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                ...
                                <p class="flex text-xs font-semibold italic leading-5 text-gray-500">
                                    {{ $item->name_latin }}
                                </p>
                    ...
                    <div class="flex flex-none items-center gap-x-2">
                        ...
                        @can('sumber.bibit.edit')
                            <a onclick="Livewire.dispatch('openModal', { component: 'modals.form-seed', arguments: {id: '{{ $item->id }}'} })"
